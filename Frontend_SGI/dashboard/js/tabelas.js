  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      data.forEach((emp) => {
        ...
        const imgUrl = emp.fotoUrl ? emp.fotoUrl : "img/user.png";
...
function carregarIndividuos(token, role) {
  $.ajax({
    ...
    success: function (data) {
      ...
      data.forEach((ind) => {
        const imgUrl = ind.fotoUrl ? ind.fotoUrl : "img/user.png";
        ...
        // Botão Ver Ficha (Ainda não criámos o editarIndividuo.html, mas fica já preparado)
